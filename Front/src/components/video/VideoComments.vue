          ...
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
              ...
              <button 
                ...
                class="text-[9px] text-sky-400/60 hover:text-sky-400 uppercase tracking-widest transition-colors font-bold"
              >
                Reply
              </button>
            </div>
          ...
          <div v-if="activeReplyId === comment.id" class="mt-4 animate-in fade-in slide-in-from-top-2">
            <div class="flex gap-2 p-1 bg-white/5 rounded-lg border border-white/10">
              ...
              <button 
                ...
                class="bg-sky-400/20 text-sky-400 px-3 py-2 text-[10px] font-bold uppercase tracking-wider hover:bg-sky-400 hover:text-white transition-all rounded-md"
              >
                Add
              </button>
            </div>
