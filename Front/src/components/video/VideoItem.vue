      ...
      <div class="flex-1 min-w-0 flex flex-col justify-center items-start text-left space-y-2">
        ...
        <div class="flex items-center flex-wrap gap-x-3 gap-y-1 text-[10px] text-slate-500 uppercase tracking-widest font-mono">
             ...
             <button 
                ...
                class="ml-1 px-3 py-1 bg-rose-500/10 text-rose-400 border border-rose-500/20 hover:bg-rose-500 hover:text-slate-900 transition-all text-[10px] uppercase tracking-widest leading-none rounded-full"
             >
                Delete
             </button>
        </div>
